...
export function getFilePreview(bucketId: string, fileId: string, width = 64, height = 64) {
    return storage.getFilePreview(bucketId, fileId, width, height);
}

export function getProfilePicturePreview(fileId: string, width = 64, height = 64) {
...
export function onCurrentUserChanged(_listener: (user: any | null) => void) {
    return () => {};
}
