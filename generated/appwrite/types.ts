...
export type AccountUsersCreate = {
    "id"?: string | null;
    "email"?: string | null;
    "name"?: string | null;
...
export type ConnectUsersCreate = {
    "username": string;
...
export type ConnectUsers = Models.Row & {
    "username": string;
    "displayName"?: string | null;
    "avatarUrl"?: string | null;
    "avatarFileId"?: string | null;
...
export type QueryBuilder<T> = {
  equal: <K extends QueryableKeys<T>>(field: K, value: any) => string;
  notEqual: <K extends QueryableKeys<T>>(field: K, value: any) => string;
  lessThan: <K extends QueryableKeys<T>>(field: K, value: any) => string;
  lessThanEqual: <K extends QueryableKeys<T>>(field: K, value: any) => string;
  greaterThan: <K extends QueryableKeys<T>>(field: K, value: any) => string;
  greaterThanEqual: <K extends QueryableKeys<T>>(field: K, value: any) => string;
  contains: <K extends QueryableKeys<T>>(field: K, value: any) => string;
  ...
  between: <K extends QueryableKeys<T>>(field: K, start: any, end: any) => string;
...
export type DatabaseTableMap = {
  "67ff05a9000296822396": {
    "accountUsers": {
      ...
      get: (id: string) => Promise<AccountUsers>;
      ...
      list: (options?: { queries?: (q: { equal: <K extends QueryableKeys<AccountUsers>>(field: K, value: any) => string; notEqual: <K extends QueryableKeys<AccountUsers>>(field: K, value: any) => string; lessThan: <K extends QueryableKeys<AccountUsers>>(field: K, value: any) => string; lessThanEqual: <K extends QueryableKeys<AccountUsers>>(field: K, value: any) => string; greaterThan: <K extends QueryableKeys<AccountUsers>>(field: K, value: any) => string; greaterThanEqual: <K extends QueryableKeys<AccountUsers>>(field: K, value: any) => string; contains: <K extends QueryableKeys<AccountUsers>>(field: K, value: any) => string; search: <K extends QueryableKeys<AccountUsers>>(field: K, value: string) => string; isNull: <K extends QueryableKeys<AccountUsers>>(field: K) => string; isNotNull: <K extends QueryableKeys<AccountUsers>>(field: K) => string; startsWith: <K extends QueryableKeys<AccountUsers>>(field: K, value: string) => string; endsWith: <K extends QueryableKeys<AccountUsers>>(field: K, value: string) => string; between: <K extends QueryableKeys<AccountUsers>>(field: K, start: any, end: any) => string; select: <K extends keyof AccountUsers>(fields: K[]) => string; orderAsc: <K extends keyof AccountUsers>(field: K) => string; orderDesc: <K extends keyof AccountUsers>(field: K) => string; limit: (value: number) => string; offset: (value: number) => string; cursorAfter: (documentId: string) => string; cursorBefore: (documentId: string) => string; or: (...queries: string[]) => string; and: (...queries: string[]) => string }) => string[] }) => Promise<{ total: number; rows: AccountUsers[] }>;
    };
    "notes": {
      create: (data: {
        "id"?: string | null;
  ...
  "chat": {
    ...
    "connectUsers": {
      create: (data: {
        ...
        "createdAt"?: string | null;
        "updatedAt"?: string | null;
      }, options?: { rowId?: string; permissions?: (permission: { read: (role: RoleString) => string; write: (role: RoleString) => string; create: (role: RoleString) => string; update: (role: RoleString) => string; delete: (role: RoleString) => string }, role: { any: () => RoleString; user: (userId: string, status?: string) => RoleString; users: (status?: string) => RoleString; guests: () => RoleString; team: (teamId: string, role?: string) => RoleString; member: (memberId: string) => RoleString; label: (label: string) => RoleString }) => string[]; transactionId?: string }) => Promise<ConnectUsers>;
      get: (id: string) => Promise<ConnectUsers>;
      update: (id: string, data: Partial<{
        "username": string;
        "displayName"?: string | null;
        "avatarUrl"?: string | null;
      ...
      delete: (id: string, options?: { transactionId?: string }) => Promise<void>;
      list: (options?: { queries?: (q: { equal: <K extends QueryableKeys<ConnectUsers>>(field: K, value: any) => string; notEqual: <K extends QueryableKeys<ConnectUsers>>(field: K, value: any) => string; lessThan: <K extends QueryableKeys<ConnectUsers>>(field: K, value: any) => string; lessThanEqual: <K extends QueryableKeys<ConnectUsers>>(field: K, value: any) => string; greaterThan: <K extends QueryableKeys<ConnectUsers>>(field: K, value: any) => string; greaterThanEqual: <K extends QueryableKeys<ConnectUsers>>(field: K, value: any) => string; contains: <K extends QueryableKeys<ConnectUsers>>(field: K, value: any) => string; search: <K extends QueryableKeys<ConnectUsers>>(field: K, value: string) => string; isNull: <K extends QueryableKeys<ConnectUsers>>(field: K) => string; isNotNull: <K extends QueryableKeys<ConnectUsers>>(field: K) => string; startsWith: <K extends QueryableKeys<ConnectUsers>>(field: K, value: string) => string; endsWith: <K extends QueryableKeys<ConnectUsers>>(field: K, value: string) => string; between: <K extends QueryableKeys<ConnectUsers>>(field: K, start: any, end: any) => string; select: <K extends keyof ConnectUsers>(fields: K[]) => string; orderAsc: <K extends keyof ConnectUsers>(field: K) => string; orderDesc: <K extends keyof ConnectUsers>(field: K) => string; limit: (value: number) => string; offset: (value: number) => string; cursorAfter: (documentId: string) => string; cursorBefore: (documentId: string) => string; or: (...queries: string[]) => string; and: (...queries: string[]) => string }) => string[] }) => Promise<{ total: number; rows: ConnectUsers[] }>;
    };
    "Follows": {
      create: (data: {
        "followerId": string;
